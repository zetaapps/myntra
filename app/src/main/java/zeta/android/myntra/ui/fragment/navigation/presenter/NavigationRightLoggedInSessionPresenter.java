...
public class NavigationRightLoggedInSessionPresenter extends ZetaRxFragmentLifeCyclePresenter<NavigationRightLoggedInSessionPresentation> {
    ...
    public NavigationRightLoggedInSessionPresenter(RxSchedulerProvider schedulerProvider, SessionManager sessionManager) {
    ...
    static abstract class SavedState implements Parcelable {
        ...
        public static Builder create() {
            return new AutoValue_NavigationRightLoggedInSessionPresenter_SavedState.Builder();
        }
