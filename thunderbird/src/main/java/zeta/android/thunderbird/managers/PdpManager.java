...
public class PdpManager {
    ...
    @Inject
    public PdpManager(MyntraDevApi devApi, ITransformer<PdpResponse, PdpModel> transformer) {
        devAPi = devApi;
    ...
    public Observable<Either<PdpModel, PdpException>> getProductDetails(ProductDetailsParams productDetailsParams) {
        return devAPi.getProductDetailsResponse(productDetailsParams.getProductId().getRawId())
