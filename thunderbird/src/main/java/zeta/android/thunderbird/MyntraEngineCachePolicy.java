...
@AutoValue
public abstract class MyntraEngineCachePolicy implements Parcelable {
    ...
    public static Builder create(File cacheDirectory) {
        return new AutoValue_MyntraEngineCachePolicy.Builder()
    ...
    public static abstract class Builder {
        ...
        public abstract MyntraEngineCachePolicy build();
    }
}
