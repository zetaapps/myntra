...
import zeta.android.thunderbird.api.apify.pdpv3.componentization.PdpComponentizationButtonResponse;
...
import zeta.android.thunderbird.models.products.pdpv3.property.PdpV3ButtonProperty;
...
public class PdpComponentizedModelTransformer implements ITransformer<PdpComponentizationResponse, PdpComponentizationModel> {
    ...
    private List<PdpV3MediaProperty> transformPdpV3MediaPropertyList(List<PdpComponentizationMediumResponse>
                                                                       pdpComponentizationMediumResponseList){
        List<PdpV3MediaProperty> pdpV3MediaPropertyList = new ArrayList<>(0);
        for(PdpComponentizationMediumResponse pdpComponentizationMediumResponse :
                pdpComponentizationMediumResponseList){
            URL mediaSource = null;
            if(pdpComponentizationMediumResponse.src != null){
                try {
                    mediaSource = new URL(pdpComponentizationMediumResponse.src);
    ...
    private PdpV3RelatedProperty transformPdpV3RelatedProperty(@Nullable PdpComponentizationRelatedResponse
                                                                 pdpComponentizationRelatedResponse){
    ...
    private PdpV3LikeProperty transformPdpV3LikeProperty(@Nullable PdpComponentizationLikesResponse
                                                           pdpComponentizationLikesResponse){
    ...
    private PdpV3InfoComponent transformPdpV3InfoComponent(PdpComponentizationComponentsResponse
                                                                   pdpComponentizationComponentsResponse){

        PdpComponentizationPropsResponse pdpComponentizationPropsResponse =
                pdpComponentizationComponentsResponse.props;
        ...
        PdpV3PriceProperty pdpV3PriceProperty = transformPdpV3PriceProperty
                (pdpComponentizationPropsResponse.price);
        PdpV3InfoTextProperty pdpV3InfoTextProperty = transformPdpV3InfoTextProperty
                (pdpComponentizationComponentsResponse.args.infoText);
        ...
        return PdpV3InfoComponent.create()
                ...
                .setPdpV3DescriptorsPropertyList(tarnsformPdpV3DescriptorsPropertyList(
                        pdpComponentizationComponentsResponse.props.descriptorList))
                .build();
    ...
    private PdpV3InfoTextProperty transformPdpV3InfoTextProperty(PdpComponentizationInfoTextResponse
                                                                         pdpComponentizationInfoTextResponse){
    ...
    private List<PdpV3DescriptorsProperty> tarnsformPdpV3DescriptorsPropertyList(@Nullable
                                                                                         List<PdpV3DescriptorResponse> pdpV3DescriptorResponseList) {
    ...
    private PdpV3BestPriceOnDemandComponent transformPdpV3BestPriceOnDemandComponent(
        ...
        @PdpV3ActionType String pdpV3ActionType = getPdpV3ActionType
                (pdpComponentizationComponentsResponse.props.actionType);
        String initialText = pdpComponentizationComponentsResponse.args.text == null ? null :
                pdpComponentizationComponentsResponse.args.text.initial;
    ...
    private PdpV3SizeSelectorComponent transformPdpV3SizeSelectorComponent(PdpComponentizationComponentsResponse
                                                                           pdpComponentizationComponentsResponse){

        PdpV3ActionProperty pdpV3ActionProperty = transformPdpV3ActionProperty
                (pdpComponentizationComponentsResponse.props.sizeRecoLazy);
        ...
        return PdpV3SizeSelectorComponent.create()
                ...
                .setRecommendationIconInformationDescription(
                        pdpComponentizationComponentsResponse.args.recoIconInfoDesc)
                .setRecommendationIconInformationText(
                        pdpComponentizationComponentsResponse.args.recoIconInfoText)
                .setSizeChartTitleText(pdpComponentizationComponentsResponse.args.sizechartTitle)
                .build();

    }

    private PdpV3ActionProperty transformPdpV3ActionProperty(PdpComponentizationSizeRecoLazyResponse
                                                                     pdpComponentizationSizeRecoLazyResponse) {
        @PdpV3ActionType String pdpV3ActionType = getPdpV3ActionType
    ...
    private List<PdpV3SizeProperty> transformPdpV3SizeProperty(@Nullable List<PdpV3SizeResponse>
                                                                       pdpV3SizeResponseList){
        ...
        for(PdpV3SizeResponse pdpV3SizeResponse : pdpV3SizeResponseList){
            ...
            pdpV3SizePropertyList.add(PdpV3SizeProperty.create()
                    ...
                    .setSizeType(pdpV3SizeResponse.sizeType == null ? null : (pdpV3SizeResponse.sizeType.toString()))
                    .setPrice(price)
                    .setDiscountedPrice(discountedPrice)
                    .setOriginalStyle(pdpV3SizeResponse.originalStyle == null ? null : (pdpV3SizeResponse.originalStyle.toString()))
                    .build());
